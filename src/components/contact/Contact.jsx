          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                shchipkov.sanya@gmail.com
              </span>

              <a
                href="mailto:shchipkov.sanya@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+380931174236</span>

              <a href="tel:+380931174236" className="contact__button">
                Call me{" "}
                <i className="uil uil-arrow-right contact__button-icon"></i>
              </a>
            </div>
            ...
            {/*  <span className="contact__card-data">Oleksandr Shchipkov</span>*/}
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@shchipkov</span>

              <a href="https://t.me/shchipkov" className="contact__button">
                Write me{" "}
                <i className="uil uil-arrow-right contact__button-icon"></i>
              </a>
            </div>

      ...
      <div className="skills__container container grid">
          ...
          <div className="skills__box">
            <div className="skills__group grid">
              {SKILLS_LIST.map((skill) => (
                <div key={skill.skillName} className="skills__data">
                  {/*<svg*/}
                  {/*  xmlns="http://www.w3.org/2000/svg"*/}
                  {/*  viewBox="0 0 24 24"*/}
                  {/*  className="skill__circle"*/}
                  {/*>*/}
                  {/*  <circle cx="12" cy="12" r="10" fill="var(--title-color)" />*/}
                  {/*</svg>*/}
                  <div>
        ...
        <div className="skills__items-list">
          {OTHER_SKILLS_LIST.map((skill) => (
            <h3 key={skill} className="skills__skill-item">
              {skill}
            </h3>
          ))}
        </div>
